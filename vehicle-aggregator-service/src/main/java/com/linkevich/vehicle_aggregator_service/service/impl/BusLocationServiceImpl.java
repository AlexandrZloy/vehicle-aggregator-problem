...
public class BusLocationServiceImpl implements VehicleLocationService {

    private final WebClient webClient;
    private final VehicleLocationMapper vehicleLocationMapper;

    public BusLocationServiceImpl(
    ...
    public Flux<VehicleLocation> getVehicleLocations() {
        return webClient
                ...
                .retrieve()
                .bodyToFlux(com.linkevich.bus_live_fare_n_location_service.openapi.model.BusLocation.class)
